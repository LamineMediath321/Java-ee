...
<body id="page-top">
    ...
    <script src="${pageContext.request.contextPath}/public/admin/js/demo/chart-area-demo.js"></script>
    <script src="${pageContext.request.contextPath}/public/admin/js/demo/chart-pie-demo.js"></script>
